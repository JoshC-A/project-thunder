...
import { cn as classNames } from "../generic/shadcn-utils";
    ...
    disabled:pointer-events-none disabled:opacity-50 active:[&>*]:translate-y-0.5`,
  {
    variants: {
      variant: {
        ...
        black: "bg-black text-primary-foreground hover:bg-black/75",
        destructive:
        ...
        custom: "",
        resolved: "bg-green-600 text-white hover:bg-green-600",
        unresolved: "bg-destructive text-white hover:bg-warning/90",
      },
      size: {
...
const Button: React.FFC<ButtonProps> = forwardRef<
