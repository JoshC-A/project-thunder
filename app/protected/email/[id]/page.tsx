...
const EmailPage = async ({ params }: Context) => {
  ...
  return (
    <div>
      <Button className="absolute top-20 left-8 pr-5 no-underline text-foreground bg-btn-background hover:bg-btn-background-hover flex items-center group text-sm">
        <a className="flex flex-row" href="/protected">
          <svg
